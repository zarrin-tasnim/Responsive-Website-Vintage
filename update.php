...
if (isset($_POST['submit'])) {
    ...
    $sql = "update `user_info` set ID=$ID,user='$name',email='$email',mobile='$mobile', password = '$password' where ID=$ID";
    $result = mysqli_query($con, $sql);
    if ($result) {
...
<body>
    ...
    <main>
        <div class="container text-center">
            <h1 class="py-4 bg-dark text-light rounded"><i class="fa-solid fa-swatchbook"></i> Book Store</h1>
        </div>
